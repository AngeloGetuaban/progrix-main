"""
Pre-built Tailwind HTML component snippets for AI prompt injection.
The AI uses these as copy-paste starting points, adapting colors,
copy, and structure to match the project's design brief.
"""
...
COMPONENTS: dict[str, list[dict]] = {
  ...
  <div class="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-center">
    <div>
      ...
      <p class="text-lg text-gray-500 mb-8">Describe your product benefit clearly. One sentence per idea. Keep it scannable.</p>
  ...
  <div class="max-w-4xl mx-auto px-6">
    ...
    <p class="text-xl text-slate-300 max-w-2xl mx-auto mb-10">Your power subheadline goes here. Short, benefit-focused, and jargon-free.</p>
    <div class="flex flex-col sm:flex-row gap-4 justify-center">
  ...
  <div class="max-w-6xl mx-auto px-6">
    <div class="text-center mb-14">
      ...
      <p class="text-lg text-gray-500 max-w-xl mx-auto">Supporting sentence that adds context to the headline.</p>
    </div>
    <div class="grid md:grid-cols-3 gap-8">
      <div class="p-6 rounded-2xl bg-gray-50 hover:bg-gray-100 transition">
        ...
        <p class="text-gray-500 text-sm">Describe the benefit in 1–2 short sentences. Focus on outcome, not technology.</p>
      </div>
      <div class="p-6 rounded-2xl bg-gray-50 hover:bg-gray-100 transition">
  ...
  <div class="max-w-5xl mx-auto px-6 grid md:grid-cols-2 gap-16 items-center">
    <div>
      ...
      <p class="text-gray-500 mb-10">A short paragraph reinforcing the headline. Keep it to 2 sentences max.</p>
      <ul class="space-y-6">
        <li class="flex gap-4">
          ...
          <div><h4 class="font-bold text-gray-900 mb-1">Benefit One</h4><p class="text-gray-500 text-sm">Short description of this benefit.</p></div>
        </li>
        <li class="flex gap-4">
          <div class="flex-shrink-0 w-10 h-10 bg-blue-100 rounded-xl flex items-center justify-center">
            <svg class="w-5 h-5 text-blue-600" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M5 13l4 4L19 7"/></svg>
          </div>
          <div><h4 class="font-bold text-gray-900 mb-1">Benefit Two</h4><p class="text-gray-500 text-sm">Short description of this benefit.</p></div>
        </li>
        <li class="flex gap-4">
          <div class="flex-shrink-0 w-10 h-10 bg-blue-100 rounded-xl flex items-center justify-center">
            <svg class="w-5 h-5 text-blue-600" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M5 13l4 4L19 7"/></svg>
          </div>
          <div><h4 class="font-bold text-gray-900 mb-1">Benefit Three</h4><p class="text-gray-500 text-sm">Short description of this benefit.</p></div>
        </li>
      </ul>
    </div>
  ...
  <div class="max-w-5xl mx-auto px-6 grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
    <div><div class="text-4xl font-extrabold text-blue-400 mb-1">10k+</div><div class="text-sm text-slate-400 uppercase tracking-wide">Happy Customers</div></div>
    <div><div class="text-4xl font-extrabold text-blue-400 mb-1">99.9%</div><div class="text-sm text-slate-400 uppercase tracking-wide">Uptime SLA</div></div>
    <div><div class="text-4xl font-extrabold text-blue-400 mb-1">500ms</div><div class="text-sm text-slate-400 uppercase tracking-wide">Avg Response</div></div>
    <div><div class="text-4xl font-extrabold text-blue-400 mb-1">4.9★</div><div class="text-sm text-slate-400 uppercase tracking-wide">Customer Rating</div></div>
  </div>
</section>""",
        }
    ],
  ...
  <div class="max-w-6xl mx-auto px-6">
    ...
    <div class="grid md:grid-cols-3 gap-6">
      <div class="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
        ...
        <p class="text-gray-600 text-sm mb-5">"This product completely changed how our team works. We saved hours every week."</p>
      ...
      <div class="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
        <div class="text-yellow-400 text-sm mb-3">★★★★★</div>
        <p class="text-gray-600 text-sm mb-5">"Exceptional support and a product that actually delivers. Setup took minutes."</p>
        <div class="flex items-center gap-3">
      ...
      <div class="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
        <div class="text-yellow-400 text-sm mb-3">★★★★★</div>
        <p class="text-gray-600 text-sm mb-5">"I recommended it to my whole team. Now we can't imagine working without it."</p>
        <div class="flex items-center gap-3">
  ...
  <div class="max-w-3xl mx-auto px-6">
    ...
    <div class="space-y-4">
      <details class="group border border-gray-200 rounded-xl overflow-hidden">
        <summary class="flex justify-between items-center p-5 cursor-pointer font-semibold text-gray-900 hover:bg-gray-50 list-none">How do I get started?<span class="text-gray-400 group-open:rotate-180 transition-transform duration-200">▾</span></summary>
        <div class="px-5 pb-5 text-gray-500 text-sm">Getting started is easy. Sign up, follow onboarding, and you'll be running in minutes.</div>
      </details>
      <details class="group border border-gray-200 rounded-xl overflow-hidden">
        <summary class="flex justify-between items-center p-5 cursor-pointer font-semibold text-gray-900 hover:bg-gray-50 list-none">Is there a free trial?<span class="text-gray-400 group-open:rotate-180 transition-transform duration-200">▾</span></summary>
        <div class="px-5 pb-5 text-gray-500 text-sm">Yes — 14-day free trial with full Pro access. No credit card required.</div>
      </details>
      <details class="group border border-gray-200 rounded-xl overflow-hidden">
        <summary class="flex justify-between items-center p-5 cursor-pointer font-semibold text-gray-900 hover:bg-gray-50 list-none">Can I cancel anytime?<span class="text-gray-400 group-open:rotate-180 transition-transform duration-200">▾</span></summary>
        <div class="px-5 pb-5 text-gray-500 text-sm">Absolutely. Cancel anytime from account settings. No questions asked.</div>
      </details>
      <details class="group border border-gray-200 rounded-xl overflow-hidden">
        <summary class="flex justify-between items-center p-5 cursor-pointer font-semibold text-gray-900 hover:bg-gray-50 list-none">Do you offer customer support?<span class="text-gray-400 group-open:rotate-180 transition-transform duration-200">▾</span></summary>
        <div class="px-5 pb-5 text-gray-500 text-sm">Yes — email support for all plans, priority for Pro, dedicated for Enterprise.</div>
      </details>
    </div>
  </div>
</section>""",
  ...
  <div class="max-w-xl mx-auto px-6">
    ...
    <form class="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 space-y-5">
      <div class="grid sm:grid-cols-2 gap-5">
        <div><label class="block text-sm font-semibold text-gray-700 mb-1">First Name</label><input type="text" placeholder="Jane" class="w-full px-4 py-3 rounded-lg border border-gray-200 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"></div>
        <div><label class="block text-sm font-semibold text-gray-700 mb-1">Last Name</label><input type="text" placeholder="Doe" class="w-full px-4 py-3 rounded-lg border border-gray-200 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"></div>
      </div>
      <div><label class="block text-sm font-semibold text-gray-700 mb-1">Email</label><input type="email" placeholder="jane@example.com" class="w-full px-4 py-3 rounded-lg border border-gray-200 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"></div>
      <div><label class="block text-sm font-semibold text-gray-700 mb-1">Message</label><textarea rows="4" placeholder="How can we help?" class="w-full px-4 py-3 rounded-lg border border-gray-200 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 resize-none"></textarea></div>
  ...
  <div class="max-w-6xl mx-auto px-6">
    ...
    <div class="border-t border-slate-800 pt-6 text-center text-xs text-slate-600">© 2025 Brand. All rights reserved.</div>
  </div>
</footer>""",
        }
    ],
...
# Which categories to inject per page type
_PAGE_TYPE_MAP: dict[str, list[str]] = {
...
# Map design-brief section IDs to component categories
_SECTION_ID_MAP: dict[str, list[str]] = {
    "hero":           ["hero"],
    "features":       ["features"],
...
def get_components_for_page(page_type: str = "landing", section_ids: list[str] | None = None) -> str:
    """
    Build a compact component-snippet block to inject into the AI prompt.
    Returns an empty string if no components match (safe to append directly).
    """
    categories: list[str] = list(_PAGE_TYPE_MAP.get(page_type, _PAGE_TYPE_MAP["landing"]))
    seen = set(categories)
    for sid in (section_ids or []):
        for cat in _SECTION_ID_MAP.get(sid, []):
            if cat not in seen:
    ...
    for cat in categories:
        for comp in COMPONENTS.get(cat, []):
            snippets.append(f"[{cat}: {comp['name']}]\n{comp['html']}")

    if not snippets:
        return ""

    lines = [
        "COMPONENT SNIPPETS — use these as exact structural starting points.",
        "Copy the HTML structure faithfully. Replace placeholder copy and adapt colors to match the design brief.",
        "",
    ]
